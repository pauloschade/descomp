...
ARCHITECTURE structure OF Atv1 IS
...
-- Equation(s):
-- \memROM~6_combout\ = ( \memROM~0_combout\ & ( (!\Endereco[3]~input_o\ & ((!\Endereco[2]~input_o\ & (!\Endereco[1]~input_o\ $ (!\Endereco[0]~input_o\))) # (\Endereco[2]~input_o\ & (!\Endereco[1]~input_o\ & !\Endereco[0]~input_o\)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000001010001000000000000000000000000010100010000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \memROM~5_combout\ = ( \memROM~0_combout\ & ( (!\Endereco[3]~input_o\ & ((!\Endereco[2]~input_o\ & (\Endereco[1]~input_o\)) # (\Endereco[2]~input_o\ & (!\Endereco[1]~input_o\ & !\Endereco[0]~input_o\)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000001010000000100000000000000000000010100000001000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_Endereco[3]~input_o\,
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000001000000000100000000000000000000010000000001000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_Endereco[3]~input_o\,
...
-- Equation(s):
-- \memROM~2_combout\ = (!\Endereco[0]~input_o\ & (!\Endereco[2]~input_o\ & (!\Endereco[3]~input_o\ & \memROM~0_combout\)))
...
-- Equation(s):
-- \memROM~3_combout\ = ( \memROM~0_combout\ & ( (!\Endereco[3]~input_o\ & ((!\Endereco[2]~input_o\) # ((!\Endereco[1]~input_o\ & !\Endereco[0]~input_o\)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000101010001000100000000000000000001010100010001000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_Endereco[3]~input_o\,
